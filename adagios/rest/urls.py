...
urlpatterns = patterns('adagios',
    url(r'^/pynag/$',   'rest.views.index', { 'module_name': 'adagios.misc.helpers' }, name="rest/pynag" ),
    url(r'^/adagios/$', 'rest.views.index', { 'module_name': 'adagios.misc.rest'    }, name="rest/adagios"),
    url(r'^/status/$', 'rest.views.index', { 'module_name': 'adagios.status.rest'    }, name="rest/status"),
    url(r'^/status.js$', 'rest.views.javascript', { 'module_name': 'adagios.status.rest'    }, ),
    url(r'^/pynag.js$', 'rest.views.javascript', { 'module_name': 'adagios.misc.helpers'    }, ),
    url(r'^/adagios.js$', 'rest.views.javascript', { 'module_name': 'adagios.misc.rest'    }, ),
    (r'^/pynag/$', 'rest.views.index', { 'module_name': 'adagios.misc.helpers' }),
