...
class SeleniumTestCase(LiveServerTestCase):
    ...
    def setUpClass(cls):
        if not webdriver:
            SeleniumTestCase.skipTest('No selenium installed')
        ...
        if os.environ.get('TRAVIS_BUILD_NUMBER') and \
           not os.environ.get('SAUCE_USERNAME'):
            ...
            SeleniumTestCase.skipTest('Travis with no sauce username, skipping')
        ...
        try:
            ...
            SeleniumTestCase.skipTest('Exception in running webdriver, skipping')
