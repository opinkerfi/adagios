...
(function() {
  ...
  (function($) {
    ...
    $.fn.dataTableExt.afnFiltering.push(function(oSettings, aData) {
      var filter_group, filter_object, filter_template;
      if ($.inArray(oSettings.nTable, obIgnoreTables) === -1) {
        return true;
      }
      if (filter_cache[oSettings["sTableId"]] === void 0) {
        return true;
      }
      ...
      return $.each($this.fetch, function(f, v) {
        ...
        $.getJSON("../rest/pynag/json/get_objects", {
          ...
          return $.each(data, function(i, item) {
            ...
            return field_array.push("<a rel=\"tooltip\" title=\"Delete object\" href=\"delete_object/id=" + item["id"] + "\">\n  <i class=\"icon-trash\"></i>\n</a>\n<a rel=\"tooltip\" title=\"Copy object\" href=\"copy_object/id=" + item["id"] + "\">\n  <i class=\"glyph-tags\"></i>\n</a>");
          });
        }).success(function() {
      ...
      dt = $this.dataTable({
        ...
        fnDrawCallback: function() {
          ...
          return $("input").click(function() {
            ...
            if (checked > 0) {
              return $("a.bulk").removeClass("inactive");
            } else {
              return $("a.bulk").addClass("inactive");
            }
          });
        }
      });
    ...
    return $.fn.adagios_ob_run_check_command = function() {
      var bar, id, modal, plugin_execution_time, step, steps, updateTimer;
      modal = $(this);
