...
(function() {
  ...
  (function($) {
    ...
    $.fn.dataTableExt.afnFiltering.push(function(oSettings, aData) {
      ...
      if (cache_type === "2" && aData[0] === "0" && aData[1] !== null) return true;
      if (cache_type === "1" && aData[2] === ("" + object_type + "group") && aData[0] !== "0") {
        if (aData[0] === "1") return true;
        if (aData[0] === "0" && aData[1] === null) return true;
      }
