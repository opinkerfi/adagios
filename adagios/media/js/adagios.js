...
(function() {
  ...
  (function($) {
    var filter_cache, filter_cache_dis, obIgnoreTables, object_types;
    ...
    $.fn.dataTableExt.afnFiltering.push(function(oSettings, aData) {
      var cache_type, object_type, show_disabled;
      ...
      if (cache_type === "0" || cache_type === "1") {
        if (aData[0] !== "0") return true;
        if (aData[1] === null || aData[1] === void 0) {
          if (show_disabled === "1") return true;
        }
      }
      if (cache_type === "2") {
        if (aData[1] !== null && aData[1] !== void 0) return true;
      }
      return false;
    });
        ...
        $.getJSON("../rest/pynag/json/get_objects", {
          ...
          return $.each(data, function(i, item) {
            ...
            return $.each(v["rows"], function(k, field) {
              ...
              cell += 'class="';
              if (item["register"] === "0" && (item["name"] === null || item["name"] === void 0)) {
                cell += "dis-object";
              }
              cell += '">';
              field_value = "";
    ...
    $.fn.adagios_ob_dtPopulate = function() {
      ...
      if (object_type !== "command" && object_type !== "timeperiod") {
        ...
        $(".toolbar_" + object_type + " div#view_filter_disable.btn-group").append("<a rel=\"tooltip\" title=\"Show disabled " + object_type + "s\" class=\"btn active\" data-filter-disabled=\"0\">\n  <i class=\"glyph-computer-service glyph-grey\"></i>\n</a>");
      ...
      $("[class^=\"toolbar_\"] div#view_filter_disable.btn-group a").on("click", function(e) {
        var $target;
        $target = $(this);
        e.preventDefault();
