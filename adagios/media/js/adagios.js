...
(function() {
  ...
  (function($) {
    ...
    $.fn.adagios_version = function() {
      ...
      $.getJSON("http://adagios.opensource.is/cgi-bin/version.cgi?version=" + current_version + "&callback=?", function(data) {
        return this;
    ...
    $.fn.adagios_datetimepicker = function(start_time, end_time) {
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        ...
        $this.find("input[name='" + which + "_hours']").val($this.data("" + which + "_time_obj").getHours() + ":" + zeropad($this.data("" + which + "_time_obj").getMinutes(), 2)).on('change', function() {
          var time, time_regex;
          console.log("cahnge");
          time = $(this).val();
    ...
    $.fn.adagios_ob_dtPopulate = function() {
      ...
      $("#" + object_type + "-tab.tab-pane label#selectall").on("click", function() {
      ...
      if (id) {
        $.post("" + BASE_URL + "rest/adagios/txt/clear_notification", {
          ...
          if (data === "success") {
            ...
            return console.log("Unable to do stuff for " + id);
          }
        });
        return e.preventDefault();
      }
