...
(function() {
  ...
  $(document).ready(function() {
    adagios.rest.pynag.source_tracker_enabled().done(function(data) {
      var id, parameters;
      ...
      if (data === true) {
        ...
        return adagios.rest.pynag.get_all_attr_src(parameters).done(function(data) {
          $("div.control-group").each(function() {
            var field_name, lbl;
            field_name = $(this).find("label.control-label").attr("for");
            lbl = $(this).find("span");
            return lbl.text(data[field_name]);
          });
          $("div.control-group").each(function() {
            return $(this).find("input").mouseenter(function() {
              var lbl;
              lbl = $(this).parent().find("span");
              lbl.fadeIn(500);
              return lbl.removeClass("hidden");
            });
          });
          return $("div.control-group").each(function() {
            return $(this).find("input").mouseleave(function() {
              var lbl;
              lbl = $(this).parent().find("span");
              lbl.fadeOut(200);
              return lbl.addClass("hidden");
            });
          });
        });
      }
