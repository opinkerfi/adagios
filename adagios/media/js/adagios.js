...
(function() {
  ...
  (function($) {
    ...
    $.fn.dataTableExt.afnFiltering.push(function(oSettings, aData) {
      ...
      if (filter_cache[object_type] === void 0) {
        return true;
      }
      if (aData[0] === "0" && filter_cache[object_type] === "2") {
        return true;
      }
      if (filter_cache[object_type] === "1" && aData[1] === ("" + object_type + "group") && aData[0] !== "0") {
        return true;
      }
      if (filter_cache[object_type] === "0" && aData[1] === object_type && aData[0] !== "0") {
        return true;
      }
      return false;
    });
